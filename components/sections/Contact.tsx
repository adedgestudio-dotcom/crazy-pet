          ...
          >
            ...
            {[
              ...
              },
              {
                ...
                content: (
                  <div>
                    ...
                    <p className="font-700 text-amber-900">9:00 AM – 8:00 PM</p>
              ...
              <motion.div
                ...
                className="bg-white rounded-2xl p-5 flex gap-4 items-start shadow-md border-2 border-orange-100 transition-all duration-300 hover:shadow-orange-soft hover:border-orange-200"
              >
            ...
            {/* WhatsApp CTA */}
            <motion.a
              href="https://wa.me/916382469764?text=Hi!%20I%20found%20your%20website%20and%20wanted%20to%20know%20more%20🐾"
              target="_blank"
              ...
              className="flex items-center justify-center gap-3 bg-linear-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white rounded-2xl p-4 font-700 transition-all duration-300 hover:shadow-2xl shadow-lg shadow-green-200"
            >
